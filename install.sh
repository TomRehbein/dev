...
echo ""
echo "  5. Install lldb for Rust DAP debugging:"
echo "       sudo apt install lldb"
echo ""
echo "  6. Open a new shell (or: source ~/.bash_profile) to pick up"
echo "     all PATH changes from this session."
echo ""
echo "  7. First nvim launch will install all plugins via lazy.nvim —"
